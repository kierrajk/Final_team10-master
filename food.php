    ...
    <div class="container-fluid" style="padding-left: 5%">
        <div class="row">
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-3 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/food1.jpg"> <img src="images/food1.jpg" alt="food1" ></a>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/food2.jpg"> <img src="images/food2.jpg" alt="food2"></a>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/donuts.jpg"> <img src="images/donuts.jpg" alt="donuts"></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-lg-offset-1 col-md-3 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/cupcakes.jpg"> <img src="images/cupcakes.jpg" alt="cupcakes" ></a>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/drink.JPG"> <img src="images/drink.JPG"  alt="drink"></a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/cake.jpg"> <img src="images/cake.jpg" alt="cake"></a>
                </div>
            </div>
